...
if (isset($_POST['addPost'])) {
    ...
    if ($result) {
        ...
        $sMessage = "เรียน ผู้เช้าห้อง  " . $room . "";
        $sMessage = $sMessage . "    ได้มีพัสดุเข้าส่งเเล้ว        หมายเลขพัสดุ" . ' ' . $numPost . "";
        $sMessage = $sMessage . '  ' . $name . '  ' . $room . '  ' . $tel . "";
        $sMessage = $sMessage . '  ' . $district . '  ' . $amphoe . '  ' . $province . ' ' . $zipcode . '';
        $sMessage = $sMessage . date("Y-m-d H:i:s") . "      ระบบแจ้งเตือนหอพักคลองหก";
