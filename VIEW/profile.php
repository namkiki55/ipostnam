                        ...
                        <form action="./edit.php">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md">
                                    ...
                                    <input type="text" class="form-control" value="<?= $_SESSION['firstname']; ?>" id="firstname" readonly>
                                </div>
                                <div class="form-group col-md">
                                    <label for="inputEmail4">lastname</label>
                                    <input type="text" class="form-control" value="<?= $_SESSION['lastname']; ?>" id="lastname" readonly>
                                </div>
                                <div class="form-group col-md">
                                    <label for="inputEmail4">password</label>
                                    <input type="password" class="form-control" value="<?=$_SESSION['Password'];?>" name="password" id="password" readonly>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md">
                                    <label for="inputEmail4">line</label>
                                    <input type="text" class="form-control" value="<?= $_SESSION['line']; ?>" id="prename" readonly>
                                </div>
                                <div class="form-group col-md">
                                    <label for="inputEmail4">tel</label>
                                    <input type="text" class="form-control" value="<?= $_SESSION['tel']; ?>" id="fname" readonly>
                                </div>
                                <div class="form-group col-md">
                                    <label for="inputEmail4">img</label>
                                    <input type="text" class="form-control" value="<?= $_SESSION['img']; ?>" id="lname" readonly>
                                </div>
                            </div>
